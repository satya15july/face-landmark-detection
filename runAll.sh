...
python3.5 prepare_data/gen_hard_bbox_rnet_onet.py --stage=rnet
### generate training data(Face Landmark Detection Part) for RNet
echo "Preparing R-Net training data: landmark"
python3.5 prepare_data/gen_landmark_aug.py --stage=rnet
### generate tfrecord file for tf training
echo "Preparing R-Net tfrecord file"
python3.5 prepare_data/gen_tfrecords.py --stage=rnet
...
python3.5 prepare_data/gen_hard_bbox_rnet_onet.py --stage=onet
### generate training data(Face Landmark Detection Part) for ONet
echo "Preparing O-Net training data: landmark"
python3.5 prepare_data/gen_landmark_aug.py --stage=onet
### generate tfrecord file for tf training
echo "Preparing O-Net tfrecord file"
python3.5 prepare_data/gen_tfrecords.py --stage=onet
